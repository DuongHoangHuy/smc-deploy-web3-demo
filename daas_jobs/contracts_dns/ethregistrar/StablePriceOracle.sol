...
//    bool public discountForHolderOfMeme = false;
    // IERC20 token;
    //
//    mapping(address => MemeToken) public memeTokenConfig;
...
//    function setTokenMeme(
//        address token,
//        MemeToken memory config
//    ) external onlyOwner {
...
//
//        if(memeTokenConfig[token].minAmount == 0) {
//            memeTokens.push(token);
//        }
//        memeTokenConfig[token] = config;
//    }
//
//    function removeTokenMeme(address token) external onlyOwner {
//        uint256 zindex = 0;
//        bool exists = false;
//
//        for (uint index = 0; index < memeTokens.length; index++) {
//            if (memeTokens[index] == token) {
//                exists = true;
//                zindex = index;
//            }
//        }
...
//
//        memeTokens[zindex] = memeTokens[memeTokens.length - 1];
//        memeTokens.pop();
//
//        delete (memeTokenConfig[token]);
//    }
